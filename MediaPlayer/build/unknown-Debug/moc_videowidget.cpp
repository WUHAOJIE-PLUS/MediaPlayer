...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->combinwidget(); break;
        case 1: _t->is_full(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoWidget::*)()>(_a, &VideoWidget::combinwidget, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (VideoWidget::*)()>(_a, &VideoWidget::is_full, 1))
            return;
    }
}
...
// SIGNAL 0
void VideoWidget::combinwidget()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void VideoWidget::is_full()
{
